...
# print(person(35, "Kudryashov", "Artuom"))
#
#
...
# print(f'Inside the function: {sum_it(5, 8,9)}')
...
# print(res)
# import my_file
# res=my_file.sum_1(5,8)

# from my_file import power
# res=power(5,6)
# print(res)
#
# res1 = prod(5, 8)
...
from my_file import *
def tests():
    assert sum_1(5, 8) == 13, f'Wrong number, actual result is {sum_1(5, 8)}'
    assert power(10, 6) == 1000000, f'Wrong number, actual result is {power(10, 6)}'
